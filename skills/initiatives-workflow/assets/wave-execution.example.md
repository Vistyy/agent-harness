...
- original objective: `materially trim workflow harness ceremony while preserving hard gates`
...
- packet path: `docs-ai/current-work/workflow-trim/wave-execution.md`
