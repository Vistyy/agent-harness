---
name: code-review
description: "Use when you need a separate isolated review of implemented changes after local verification, or when closeout requires final separate review; not for in-thread `quality_guard`."
---
