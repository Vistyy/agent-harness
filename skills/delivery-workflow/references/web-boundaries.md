...
Use when the touched owner is a browser route, page, shared UI module, facade,
or screen model.
...
- Shared UI exposes generic contracts, not one caller's workflow hidden behind
  defaults.
- Feature behavior enters through explicit props/config or stays feature-owned.
