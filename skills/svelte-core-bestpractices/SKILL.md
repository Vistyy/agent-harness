...
description: Use alongside svelte-code-writer for durable Svelte posture, reactivity pitfalls, thin-route anti-patterns, styling boundaries, and Svelte-specific code-shape guidance; official docs own version-sensitive APIs.
---
